...
public class Track {
  ...
  Track(int map) {
    ...
    mapNumber = map;
    if (map == 0) {
      Block startBlock = new Block(0, 100, 75, -50, 250);//needs to be invisible
      blockList.add(startBlock);
      
      
      Block firstBlock = new Block(0, 100, 75, 50, 250);
      startBlock.setNextBlock(firstBlock);
      blockList.add(firstBlock);
      
      Block secondBlock = new Block(0, 100, 75, 150, 250);
      firstBlock.setNextBlock(secondBlock);
      blockList.add(secondBlock);
      
      Block thirdBlock = new Block(270, 75, 75, 237.5, 250); //turn up
      secondBlock.setNextBlock(thirdBlock);
      blockList.add(thirdBlock);
      
      Block fourthBlock = new Block(270, 75, 100, 237.5, 162.5);
      thirdBlock.setNextBlock(fourthBlock);
      blockList.add(fourthBlock);
      
      Block fifthBlock = new Block(0, 75, 75, 237.5, 75); //turn right
      fourthBlock.setNextBlock(fifthBlock);
      blockList.add(fifthBlock);
      
      Block sixthBlock = new Block(0, 100, 75, 325, 75); 
      fifthBlock.setNextBlock(sixthBlock);
      blockList.add(sixthBlock);
      
      Block sevenBlock = new Block(90, 75, 75, 412.5, 75); //turn down
      sixthBlock.setNextBlock(sevenBlock);
      blockList.add(sevenBlock);
      
      Block block8 = new Block(90, 75, 100, 412.5, 162.5);
      sevenBlock.setNextBlock(block8);
      blockList.add(block8);
      
      Block block9 = new Block(90, 75, 100, 412.5, 162.5);
      block8.setNextBlock(block9);
      blockList.add(block9);
      
      Block block10 = new Block(90, 75, 100, 412.5, 262.5);
      block9.setNextBlock(block10);
      blockList.add(block10);
      
      Block block11 = new Block(90, 75, 100, 412.5, 362.5);
      block10.setNextBlock(block11);
      blockList.add(block11);
      
      Block block12 = new Block(180, 75, 75, 412.5, 450); //turn left
